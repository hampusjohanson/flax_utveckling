Attribute VB_Name = "Labeling_13"
Option Explicit

Sub AdjustFlankLabels3()
    Dim sld As slide
    Dim shp As shape
    Dim chrt As chart
    Dim srs As series
    ...
    Dim verticalThreshold As Double: verticalThreshold = 5 ' Pixels to consider labels as vertically close
    Dim horizontalThreshold As Double: horizontalThreshold = 5 ' Pixels to consider labels as horizontally close
