...
Sub PV_1()
    ...
    ' Clear previous data in range
    Debug.Print "Clearing data range: A2:C51"
    chartSheet.Range("A2:C51").ClearContents
    ...
    rowIndex = 0
    chartRow = 2 ' Start from row 2 in Excel

    Do While Not EOF(fileNumber) And chartRow <= 51
