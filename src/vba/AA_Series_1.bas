...
Sub AA_Series_1()
    ...
    For rowIndex = 1 To tableShape.table.Rows.count
        ...
        ' If the value is "yes", include corresponding B-column value from the chart
        If currentCellValue = "yes" Then
            yValues.Add "B" & (rowIndex + 1) ' Store row index for later retrieval
        End If
    Next rowIndex
    ...
    With newSeries.Format.Fill
        .visible = msoTrue
        .ForeColor.RGB = RGB(68, 67, 102) ' Hex #444366
        .Solid
    End With
