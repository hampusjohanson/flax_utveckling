Attribute VB_Name = "AA_Count_boxes_series_A4"
Sub AA_Count_boxes_series_A4()
    ...
    val1 = series1.values(4)
    val2 = series2.values(4)
    ...
    If leftieBox Is Nothing Then
        MsgBox "No shape named 'Leftie_4' found.", vbExclamation
        Exit Sub
    End If
