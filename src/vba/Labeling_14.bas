Attribute VB_Name = "Labeling_14"
Option Explicit

Sub AdjustFlankLabels4()
    Dim sld As slide
    Dim shp As shape
    Dim chrt As chart
    Dim srs As series
    ...
    Dim includeTop As Boolean: includeTop = False
    Dim includeBottom As Boolean: includeBottom = True
    Dim verticalThreshold As Double: verticalThreshold = 25 ' Pixels to consider labels as vertically close
    Dim horizontalThreshold As Double: horizontalThreshold = 25 ' Pixels to consider labels as horizontally close
