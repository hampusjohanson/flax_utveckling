...
Sub AA_Series_4()
    ...
    For rowIndex = 1 To tableShape.table.Rows.count
        ...
        ' If the value is "yes", include corresponding E-column value from the chart
        If currentCellValue = "yes" Then
            yValues.Add "E" & (rowIndex + 1) ' Store row index for later retrieval
        End If
    Next rowIndex
    ...
    newSeries.Name = "Serie4" & chartShape.chart.SeriesCollection.count
