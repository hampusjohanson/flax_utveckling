Attribute VB_Name = "Lines_Legend_New_4b"
Public brand_count As Integer

Sub Lines_Legend_New_D1()
...
Sub Lines_Legend_New_D5()
    ...
    numRows = 4 ' för exakt 4 varumärken: serie 7–10
    ...
    Debug.Print "Brand_List_2 färdig: rätt färger från serie 7–10"
End Sub


Sub Lines_Legend_New_D6()
    Dim pptSlide As slide
    Dim shapeTbl As shape
    Dim tbl As table
    Dim r As Integer
