Attribute VB_Name = "labeling_heights"
Option Explicit

Public LabelNames() As String
Public LabelHeights() As Double
        ...
        If shp.hasChart Then
            ...
            If chrt.SeriesCollection.count > 0 Then
                ...
                If RealLabelCount > 0 Then
                    ' Skapa arrayer för att lagra namn och höjder
                    ReDim LabelNames(1 To RealLabelCount)
                    ReDim LabelHeights(1 To RealLabelCount)

                    ' **Andra genomgången: Spara etiketter och höjder**
                    ...
                    For i = 1 To srs.Points.count
                        If srs.Points(i).HasDataLabel Then
                            ...
                            If lblText <> "false" And lblText <> "falskt" And Len(lblText) > 0 Then
                                ...
                                LabelHeights(RealLabelCount) = lblHeight

                                ' Debug: Skriv ut etikett och höjd
                                Debug.Print "Label: " & lblText & " | Height: " & lblHeight
                            End If
                        End If
                    Next i
                Else
