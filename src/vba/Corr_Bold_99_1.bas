Attribute VB_Name = "Corr_Bold_99_1"
Sub Corr_Bold_99_1()
    ...
    For Each s In pptSlide.Shapes
        If s.HasTable Then
            ...
            ' Remove bold formatting in columns 1 and 2 for all rows except row 1
            If Not tbl Is Nothing Then
                For rowIndex = 2 To tbl.Rows.count ' Start from row 2
    ...
    Debug.Print "Bold formatting cleared from all rows except row 1."
End Sub
