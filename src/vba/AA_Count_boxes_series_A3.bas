Attribute VB_Name = "AA_Count_boxes_series_A3"
Sub AA_Count_boxes_series_A3()
    ...
    val1 = series1.values(3)
    val2 = series2.values(3)
    ...
    If leftieBox Is Nothing Then
        MsgBox "No shape named 'Leftie_3' found.", vbExclamation
        Exit Sub
    End If
