Attribute VB_Name = "AA_Count_boxes_series_A1"
Sub AA_Count_boxes_series_A1()
    ...
    val1 = series1.values(1)
    val2 = series2.values(1)
    ...
    If leftieBox Is Nothing Then
        MsgBox "No shape named 'Leftie_1' found.", vbExclamation
        Exit Sub
    End If
