Attribute VB_Name = "Lines_Legend_New_5b"
Public brand_count As Integer

Sub Lines_Legend_New_C1()
...
Sub Lines_Legend_New_C2()
    ...
    Debug.Print "Brand_List_2 created with fixed size and 5 rows"
End Sub

Sub Lines_Legend_New_C3()
    Dim pptSlide As slide
...
Sub Lines_Legend_New_C5()
    ...
    numRows = brand_count - 6 ' 5 eller 6 rader beroende på antal varumärken
    ...
    Debug.Print "Brand_List_2 färdig: rätt färger från serie 7–" & brand_count
End Sub

Sub Lines_Legend_New_C6()
    Dim pptSlide As slide
    Dim shapeTbl As shape
    Dim tbl As table
    Dim r As Integer
...
Sub Lines_Legend_New_C7()
    ...
    Debug.Print "Varumärkesnamn (serie 7–11) inmatade i Brand_List_2"
End Sub



Sub Lines_Legend_New_C8()
    Dim pptSlide As slide
    Dim shapeTbl As shape
    Dim tbl As table
    Dim r As Integer, c As Integer
