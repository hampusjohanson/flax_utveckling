        ...
        If shp.hasChart Then
            ...
            If chrt.SeriesCollection.count > 0 Then
                ...
                If RealLabelCount > 0 Then
                    ...
                    ' **Andra genomgången: Spara etiketter och justera bredder**
                    ...
                    For i = 1 To srs.Points.count
                        If srs.Points(i).HasDataLabel Then
                            ...
                            lblText = Replace(lblText, Chr(160), "") ' Ta bort icke-brytande mellanslag
                            CharCount = Len(lblText) ' Antal tecken
                            DesiredWidth = (10 * CharCount) / 72 * 28.35 ' Konvertera till cm

                            ' Endast spara riktiga etiketter
                            If lblText <> "false" And lblText <> "falskt" And CharCount > 0 Then
                                RealLabelCount = RealLabelCount + 1
                                LabelNames(RealLabelCount) = lblText
                                LabelWidths(RealLabelCount) = DesiredWidth
                                lbl.width = DesiredWidth ' Justera etikettens bredd

                        

                                ' Debug: Skriv ut etikett, antal tecken och ny bredd
                                Debug.Print "Label: " & lblText & " | Characters: " & CharCount & " | Set Width: " & DesiredWidth & " cm"
                            End If
                        End If
                    Next i
                Else
